"""Volume Weighted TDS Calculator

File: Volume_Weighted_TDS_calculator.py
Description: Program to calculate Volume-Weighted TDS of Lake
              systems with specific conductance profiles and TDS data
...
def main():
    ...
    # try:
    VolumeWeightedObject.get_regression()
    ...
    try:
        VolumeWeightedObject.get_volume_weighted_tds()
